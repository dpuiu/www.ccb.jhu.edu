...
{{ccb}}(CCB) is a multidisciplinary center
...
{{CCB}} is organized as a research center within the {{WSE}} , with faculty members spanning {{WSE}}, the {{som}}
, the {{sph}}, and the {{ksas}}. The Center
is closely affiliated with (1) the {{BME}} , which is in the Schools of Medicine
and Engineering; (2) the {{cs}} in the {{wse}},
and (3) the {{biostats}} in the {{sph}}.
