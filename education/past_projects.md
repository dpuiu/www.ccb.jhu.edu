...
- Kevin Huang (UG) — Improved microbial gene finding using large protein sequence datasets (mentor Steven Salzberg)
...
- Shannon Rainsford (UG) — Enrichment analysis of subcompartments in topologically associated domains (mentor James Taylor)
...
- Andrew Wang — *Metagenomics analysis of arctic peat and agricultural field samples* (mentor Daniela Puiu)
...
- Jaime Morton — *Myrna2: Differential gene expression* (mentor Ben Langmead)
