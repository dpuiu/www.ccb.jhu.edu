...
We offer comprehensive analyses of sequencing data for a variety of genomics and
other sequencing-based experiments, some of which are listed below. We can
handle most types of sequencing data, including Illumina, PacBio, 454, and
...
needs, and we send you results of all analyses.

## Pricing

Prices for individual projects will depend on the size and demands of the
project, including the need for designing custom solutions. While we cannot
