...
- [Next-Generation Sequence Alignment Software](#nextgen)
- [Metagenomics Classification, Abundance Estimation and
  Visualization](#metagenomics)
- [Computational Gene Finding](#genefinding)
- [Genome Assembly and Large-Scale Genome alignment](#assembly)
- [Sequence Analysis Tools](#seqanalysis)
- [Variant Analysis Tools](#varanalysis)
- [Webservers and Databases](#webservers)

\
**If you\'re looking for the CHESS human gene database, it is at
[ccb.jhu.edu/chess](http://ccb.jhu.edu/chess) **\
****
...
40-node, 320-core cluster rented from [Amazon\'s
EC2](http://aws.amazon.com) utility computing service.
...
[**How to Choose a Metagenomics
Classifier**](/software/choosing-a-metagenomics-classifier/)
...
paper
here](http://ccb.jhu.edu/people/salzberg/docs/AMOScmp-reprint.pdf).\
:::
...
desktop computer. [See the journal paper
here.](http://genomebiology.com/2007/8/3/R34)
:::
...
[**BRCA gene
testing**](http://ccb.jhu.edu/software/BRCA-diagnostic/index.shtml)\
...
::: {align="left"}
[gffread](/software/stringtie/gff.shtml#gffread): a program for
filtering, converting and manipulating GFF files
:::
...
Web servers for displaying alignments and annotations of bacterial
genomes. 

[A collection of links (now very old) to external sequence analysis
programs.](http://cbcb.umd.edu/%7Esalzberg/appendixa.html)
